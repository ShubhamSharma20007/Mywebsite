...
window.addEventListener('load', () => {
    ...
    const path2 = 'https://node.scaleedge.in/'
    ...
    const port = document.querySelector('.porfolio-gsap')
    const path4 = 'https://gsap-classic.netlify.app/'
    ...
    const projectBtn = document.querySelector(".border");
